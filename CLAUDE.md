...
This project is indexed by GitNexus as **mavra-monitor-system** (10645 symbols, 19253 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
