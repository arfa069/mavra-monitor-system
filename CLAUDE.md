...
This project is indexed by GitNexus as **price-monitor** (7848 symbols, 14813 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
