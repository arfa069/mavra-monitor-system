  ...
  Future<TodaySnapshot> loadToday() async => const TodaySnapshot(
    ...
    attentionItems: [
      TodayAttentionItem(
        ...
        timeLabel: 'Today',
        title: 'Taobao rice cooker reached target price',
      ...
      TodayAttentionItem(
        ...
        timeLabel: 'Later',
        title: 'Senior Flutter Engineer worth opening later',
    ...
    moduleStatuses: [
      TodayModuleStatus(
        ...
        summary: '3 items dropped to target prices.',
        route: '/products',
      ),
      TodayModuleStatus(
        label: 'Job Radar',
        state: TodayStatusState.attention,
        summary: '8 jobs worth looking at.',
        route: '/jobs',
      ),
      TodayModuleStatus(
        label: 'Smart Home',
        state: TodayStatusState.attention,
        summary: '2 devices require attention.',
        route: '/smart-home',
      ),
    ],
  );
