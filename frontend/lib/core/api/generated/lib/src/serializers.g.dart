    ...
    (Serializers().toBuilder()
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(AdminUserResponse),
            ]),
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(JobConfigScheduleInfo),
            ]),
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(MatchResultResponse),
            ]),
            () => ListBuilder<MatchResultResponse>(),
          )
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(PermissionResponse),
            ]),
            () => ListBuilder<PermissionResponse>(),
          )
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(RolePermissionResponse),
            ]),
            () => ListBuilder<RolePermissionResponse>(),
          )
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(ProductBatchCreateItem),
            ]),
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(ResourcePermissionResponse),
            ]),
