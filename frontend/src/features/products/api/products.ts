...
export const productsApi = {
  ...
  create: (data: ProductCreateRequest) => api.post<Product>("/v1/products", data),
  ...
  batchUpdate: (ids: number[], active?: boolean) =>
    api.post<BatchOperationResult[]>("/v1/products/batch-update", { ids, active }),
  ...
  updateCronConfig: (platform: string, data: ProductPlatformCronUpdate) =>
    api.patch<ProductPlatformCron>(`/v1/products/cron-configs/${platform}`, data),
