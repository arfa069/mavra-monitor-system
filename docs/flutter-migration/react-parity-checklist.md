...
| `/jobs` | `frontend/src/features/jobs/JobsPage.tsx` | `frontend/lib/features/jobs/` | configs, jobs, resumes, matching, profiles, backup | Not started |
| `/products` | `frontend/src/features/products/ProductsPage.tsx` | `frontend/lib/features/products/` | product CRUD, price history, batch import, crawl logs | Not started |
