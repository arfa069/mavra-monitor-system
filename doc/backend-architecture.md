...
| `/crawl-profiles`   | `/v1/crawl-profiles`, `/api/v1/crawl-profiles`     | `domains/crawling/profile_router.py` | profile 列表/创建/状态更新/过期租约释放       |
...
- `domains/crawling/profile_router.py` — `/crawl-profiles` 管理端点：list/create/update/release-stale。
